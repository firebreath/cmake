  ...
  cmMakefileTargetGenerator(target)
{
  ...
  if(this->Target->IsFrameworkOnApple())
    ...
    // XCODE_ATTRIBUTE_WRAPPER_EXTENSION is how you tell xcode to set
    // a specific extension on such a project.
    if (!ext) ext = this->Target->GetProperty("XCODE_ATTRIBUTE_WRAPPER_EXTENSION");
    if (ext)
        this->MacContentDirectory += ext;
    else
        this->MacContentDirectory += "framework";
    ...
    if (ext)
        ...
        this->MacContentDirectory += "bundle";
